...
public class buttonsMessageAdapter extends  RecyclerView.Adapter<buttonsMessageAdapter.MyViewHolder>  implements View.OnClickListener {
    private ArrayList<Buttons> buttons ;
    private Activity activity;
    Context context;
    public buttonsMessageAdapter(ArrayList<Buttons> buttons){
    ...
    @NonNull
    @Override
    public buttonsMessageAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull buttonsMessageAdapter.MyViewHolder holder, int position) {
